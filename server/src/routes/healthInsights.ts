...
// ─── Garmin fetch (extracted from the /garmin route above) ────────────────────

async function fetchGarminInsights(userId: number, date: string) {
...
async function fetchPolarInsights(userId: number, date: string) {
